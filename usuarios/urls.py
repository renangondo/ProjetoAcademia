...
from .views import EstadoCreate, CidadeCreate, AlunoCreate
from .views import AlunoUpdate, CidadeUpdate, EstadoUpdate
from .views import EstadoDelete, CidadeDelete, AlunoDelete
from .views import EstadoList, CidadeList, AlunoList
